package ch.bbw.cardgame.control;

import ch.bbw.cardgame.dao.CardDBConnector;
import ch.bbw.cardgame.model.Car;
import ch.bbw.cardgame.model.Player;
...
public class ViewController {
    ...
    Car leftCar = null;
    Car rightCar = null;
    Player leftPlayer = new Player("Left player");
    Player rightPlayer = new Player("Right player");

    //TODO implement a class StatisticDBConnector
    //@Autowired
    //StatisticDBConnector statisticDBConnector = new StatisticDBConnector();
    ...
    private void setup() {
        ...
        //TODO write statistic start-log-statement here
        //statisticDBConnector.writeStartLogStatement(leftPlayer, leftCarList, rightPlayer, rightCarList);
    }
    ...
    public String moveCardToLeft(Model model) {
        if (rightCarList.isEmpty()) {
            ...
            //TODO write statistic swap-log-statement here
            // DBConnector.writeSwapLogStatement(...

            //TODO write statistic win-log-statement here
            //  if (rightCarList.isEmpty() ...
            //     DBConnector.writeWinLogStatement(leftPlayer);
        }
        leftCar = null;
        rightCar = null;
        model.addAttribute("leftCar", leftCar);
    ...
    public String moveCardToRight(Model model) {
        if (leftCarList.isEmpty()) {
            ...
            //TODO write statistic win-log-statement here
            //  if (leftCarList.isEmpty() ...
            //     DBConnector.writeWinLogStatement(rightPlayer);
